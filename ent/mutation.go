...
func (m *QrCodeMutation) SetURL(s string) {
	m.url = &s
}

// URL returns the value of the "url" field in the mutation.
func (m *QrCodeMutation) URL() (r string, exists bool) {
	v := m.url
	if v == nil {
		return
	}
...
// OldURL returns the old "url" field's value of the QrCode entity.
// If the QrCode object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *QrCodeMutation) OldURL(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *QrCodeMutation) ResetURL() {
	m.url = nil
}

// SetImage sets the "image" field.
func (m *QrCodeMutation) SetImage(s string) {
	m.image = &s
}

// Image returns the value of the "image" field in the mutation.
func (m *QrCodeMutation) Image() (r string, exists bool) {
	v := m.image
	if v == nil {
		return
	}
...
// OldImage returns the old "image" field's value of the QrCode entity.
// If the QrCode object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *QrCodeMutation) OldImage(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *QrCodeMutation) ResetImage() {
	m.image = nil
}
...
func (m *QrCodeMutation) Fields() []string {
	...
	if m.url != nil {
		fields = append(fields, qrcode.FieldURL)
	}
	if m.image != nil {
		fields = append(fields, qrcode.FieldImage)
	}
	return fields
}
